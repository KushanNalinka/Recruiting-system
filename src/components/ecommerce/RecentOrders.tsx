...
interface Product {
  ...
  status: "Online" | "Offline" | "Leave"; // Status of the product
}
...
const tableData: Product[] = [
  {
    ...
    variants: "Vice President - Talent Acquisition",
  ...
  {
    id: 5,
    name: "Sewmini Mahawaththa",
    variants: "Senior Manager- Technical Interview",
    category: "Development",
    price: "1143",
    status: "Online",
